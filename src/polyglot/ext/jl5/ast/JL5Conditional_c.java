...
public class JL5Conditional_c extends Conditional_c {
    ...
    public Node typeCheck(TypeChecker tc) throws SemanticException {
        ...
        if ((ts.typeEquals(t1, ts.Boolean()) && ts.typeEquals(t2, ts.typeForName("java.lang.Boolean"))) ||
                (ts.typeEquals(t2, ts.Boolean()) && ts.typeEquals(t1, ts.typeForName("java.lang.Boolean")))) {
        ...
        if (t1.isNumeric() && t2.isNumeric()) {
            ...
            if ((t1.isByte() || t1.equals(ts.typeForName("Byte")) && 
                    (t2.isShort() || t2.equals(ts.typeForName("java.lang.Short"))))) {
                return type(ts.Short());
            }
            if ((t2.isByte() || t2.equals(ts.typeForName("Byte")) && 
