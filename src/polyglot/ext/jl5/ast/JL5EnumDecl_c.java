...
public class JL5EnumDecl_c extends JL5ClassDecl_c implements JL5EnumDecl {
    ...
    protected Node addEnumMethods(TypeSystem ts, NodeFactory nf) {
        ...
        // add values method
        JL5MethodInstance valuesMI = (JL5MethodInstance) ts.methodInstance(position(), this.type(), flags, ts.arrayOf(this.type()), "values", Collections.<Type> emptyList(), Collections.<Type> emptyList());
