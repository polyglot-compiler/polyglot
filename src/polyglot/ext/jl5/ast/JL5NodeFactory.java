...
public interface JL5NodeFactory extends NodeFactory {
	...
	EnumConstantDecl EnumConstantDecl(Position pos, Flags flags, Id name,
	...
	JL5ConstructorDecl ConstructorDecl(Position pos, Flags flags, Id name,
	...
	New New(Position pos, List<TypeNode> typeArgs, TypeNode type, List args,
			ClassBody body);
	...
	ConstructorCall ConstructorCall(Position pos, Kind kind, Expr outer,
			List args, boolean isEnumSuperCall);
