...
public interface JL5NodeFactory extends NodeFactory {
    ...
    EnumConstantDecl EnumConstantDecl(Position pos, Flags flags, List<AnnotationElem> annotations,Id name, List<Expr> args);
    ...
    AmbTypeInstantiation AmbTypeInstantiation(Position pos, TypeNode base, List<TypeNode> typeArguments);
    ...
    New New(Position pos, Expr outer, List<TypeNode> typeArgs, TypeNode objectType, List<Expr> args, ClassBody body);
    ConstructorCall ConstructorCall(Position pos, Kind kind, Expr outer, List<? extends Expr> args, boolean isEnumSuperCall);
