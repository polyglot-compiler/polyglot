...
public class JL5NodeFactory_c extends JL5AbstractNodeFactory_c {
    ...
    @Override
    public AmbTypeInstantiation AmbTypeInstantiation(
            Position pos, TypeNode base, List<TypeNode> typeArguments) {
        AmbTypeInstantiation n =
                new AmbTypeInstantiation(pos, base, CollectionUtil.nonNullList(typeArguments));
    ...
    @Override
    public AnnotationElemDecl AnnotationElemDecl(
            Position pos, Flags flags, TypeNode type, Id name, Term defaultValue, Javadoc javadoc) {
        AnnotationElemDecl n =
                new AnnotationElemDecl_c(pos, flags, type, name, defaultValue, javadoc);
    ...
    @Override
    public AnnotationElemDecl AnnotationElemDecl(
            Position pos, Flags flags, TypeNode type, Id name, Term defaultValue) {
        return AnnotationElemDecl(pos, flags, type, name, defaultValue, null);
    }

    @Override
    public ClassDecl EnumDecl(
            Position pos,
            Flags flags,
            ...
            ClassBody body,
            Javadoc javadoc) {
        ClassDecl n = new ClassDecl_c(pos, flags, name, superType, interfaces, body, javadoc);
    ...
    public ClassDecl EnumDecl(
            ...
            List<TypeNode> interfaces,
            ClassBody body) {
        return EnumDecl(pos, flags, annotations, name, superType, interfaces, body, null);
    }

    @Override
    public final Call Call(Position pos, Receiver target, Id name, List<Expr> args) {
        return Call(pos, target, null, name, args);
    }

    @Override
    public Call Call(
            Position pos, Receiver target, List<TypeNode> typeArgs, Id name, List<Expr> args) {
        Call n = super.Call(pos, target, name, CollectionUtil.nonNullList(args));
    ...
    public final ClassDecl ClassDecl(
            ...
            ClassBody body,
            Javadoc javadoc) {
        return ClassDecl(pos, flags, null, name, superClass, interfaces, body, null, javadoc);
    }
    ...
    public final ClassDecl ClassDecl(
            ...
            List<TypeNode> interfaces,
            ClassBody body) {
        return ClassDecl(pos, flags, null, name, superClass, interfaces, body, null, null);
    }
    ...
    public ClassDecl ClassDecl(
        ...
        ClassDecl n = super.ClassDecl(pos, flags, name, superType, interfaces, body, javadoc);
    ...
    public ClassDecl ClassDecl(
            ...
            ClassBody body,
            List<ParamTypeNode> paramTypes) {
        ClassDecl n = super.ClassDecl(pos, flags, name, superType, interfaces, body);
        JL5ClassDeclExt ext = (JL5ClassDeclExt) JL5Ext.ext(n);
        ext.paramTypes = CollectionUtil.nonNullList(paramTypes);
        ext.annotations = CollectionUtil.nonNullList(annotations);
        return n;
    ...
    @Override
    public final ConstructorCall ConstructorCall(
            Position pos, Kind kind, Expr outer, List<Expr> args) {
    ...
    public final ConstructorDecl ConstructorDecl(
            ...
            Javadoc javadoc) {
        ConstructorDecl n =
                ConstructorDecl(pos, flags, null, name, formals, throwTypes, body, null, javadoc);
        return n;
    }
    ...
    public final ConstructorDecl ConstructorDecl(
            ...
            Block body) {
        ConstructorDecl n =
                ConstructorDecl(pos, flags, null, name, formals, throwTypes, body, null);
        return n;
    }
    ...
    public ConstructorDecl ConstructorDecl(
            ...
            Javadoc javadoc) {
        ConstructorDecl n =
                super.ConstructorDecl(pos, flags, name, formals, throwTypes, body, javadoc);
    ...
    public ConstructorDecl ConstructorDecl(
        ...
        return ConstructorDecl(
                pos, flags, annotations, name, formals, throwTypes, body, typeParams, null);
    }
    ...
    @Override
    public ElementValueArrayInit ElementValueArrayInit(Position pos, List<Term> elements) {
    ...
    @Override
    public EnumConstantDecl EnumConstantDecl(
            Position pos,
            Flags flags,
            List<AnnotationElem> annotations,
            Id name,
            ...
            ClassBody body,
            Javadoc javadoc) {
        EnumConstantDecl n = new EnumConstantDecl_c(pos, flags, name, args, body, javadoc);
    ...
    @Override
    public final FieldDecl FieldDecl(
    ...
    @Override
    public final MethodDecl MethodDecl(
            Position pos,
            Flags flags,
            TypeNode returnType,
            Id name,
    ...
    public final MethodDecl MethodDecl(
            ...
            Block body) {
        MethodDecl n =
                MethodDecl(pos, flags, null, returnType, name, formals, throwTypes, body, null);
        return n;
    }
    ...
    public MethodDecl MethodDecl(
            ...
            Javadoc javadoc) {
        MethodDecl n =
                super.MethodDecl(pos, flags, returnType, name, formals, throwTypes, body, javadoc);
    ...
    @Override
    public final New New(
            Position pos, Expr outer, TypeNode objectType, List<Expr> args, ClassBody body) {
    ...
    @Override
    public AnnotationElem NormalAnnotationElem(
            Position pos, TypeNode name, List<ElementValuePair> elements) {
        AnnotationElem n = new AnnotationElem_c(pos, name, CollectionUtil.nonNullList(elements));
        n = ext(n, extFactory().extNormalAnnotationElem());
        return n;
    }

    @Override
    public ParamTypeNode ParamTypeNode(Position pos, Id id, List<TypeNode> bounds) {
        ParamTypeNode n = new ParamTypeNode_c(pos, id, CollectionUtil.nonNullList(bounds));
    ...
    @Override
    public TypeNode TypeNodeFromQualifiedName(
            Position pos, String qualifiedName, List<TypeNode> typeArguments) {
        TypeNode base = super.TypeNodeFromQualifiedName(pos, qualifiedName);
        if (typeArguments.isEmpty()) return base;
