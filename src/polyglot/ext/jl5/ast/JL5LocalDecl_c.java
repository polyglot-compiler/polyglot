...
public class JL5LocalDecl_c extends LocalDecl_c implements LocalDecl,
    ...
    protected LocalDecl reconstruct(TypeNode type, Expr init, List<AnnotationElem> annotations){
    ...
    public Node typeCheck(TypeChecker tc) throws SemanticException {
        ...
        if (type().type() instanceof TypeVariable && tc.context().inStaticContext()){
            if (((TypeVariable)type().type()).declaredIn().equals(TVarDecl.CLASS_TYPE_VARIABLE))
