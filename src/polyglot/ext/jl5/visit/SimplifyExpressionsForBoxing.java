...
public class SimplifyExpressionsForBoxing extends HaltingVisitor {
    ...
    private Node simplifyUnary(Unary u, boolean discardValue) {
         ...
         * Change --x to (x -= 1)
         */
        if (Unary.PRE_DEC.equals(u.operator()) || Unary.PRE_INC.equals(u.operator())
                || (discardValue && (Unary.POST_DEC.equals(u.operator()) 
            ...
            Expr left = u.expr();
            boolean add = Unary.PRE_INC.equals(u.operator())
                    || Unary.POST_INC.equals(u.operator());
            Assign.Operator newOp = add ? Assign.ADD_ASSIGN : Assign.SUB_ASSIGN;
            Assign ass = nf.Assign(u.position(), 
                                   left, 
                                   newOp, 
            ...
            Binary b = nf.Binary(u.position(), sa,
    ...
    protected Expr simplifyAssignment(Assign ass) {
        ...
        Binary b = nf.Binary(ass.position(), 
