...
public interface JL5ClassType extends ClassType {
	 ...
	 * 
	 * @param toType
	 * @return null if this class cannot be cast to toType. Otherwise, list
	 *         where the first element is this and the last element is toType,
	 *         and each conversion adds an element to the list.
	 */
	LinkedList<Type> isImplicitCastValidChainImpl(Type toType);

	/**
	 * Translate the type as it should be if it where the receiver of a field or
	 * method call.
	 * 
	 * @param context
	 */
