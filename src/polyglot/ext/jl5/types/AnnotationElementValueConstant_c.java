...
public class AnnotationElementValueConstant_c extends TypeObject_c
        implements AnnotationElementValueConstant {
    private static final long serialVersionUID = SerialVersionUID.generate();

    private Type type;
    private Object constVal;

    public AnnotationElementValueConstant_c(
            JL5TypeSystem ts, Position pos, Type type, Object constVal) {
        super(ts, pos);
        this.type = type;
