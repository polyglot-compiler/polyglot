...
public class TypeVariable_c extends ReferenceType_c implements TypeVariable {
	...
	// private ParsedClassType syntheticClass; // SC: should probably combine
	// with bounds, and have intersection classes...
	...
	/**
	 * It is possible for type variables to have lower bounds. See JLS 3rd ed
	 * 4.10.2 and 5.1.10
	 */
	...
	public ReferenceType erasureType() {
		return (ReferenceType) ((JL5TypeSystem) this.typeSystem())
				.erasureType(this);
	}
