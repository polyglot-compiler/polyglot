...
public class TypeVariable_c extends ReferenceType_c implements TypeVariable {
    ...
    public void setDeclaringProcedure(JL5ProcedureInstance pi) {
        if (this.declaredIn == TVarDecl.PROCEDURE_TYPE_VARIABLE && this.declaringProcedure == pi) {
            // nothing to do, the fields already match.
            return;
        }
        if (this.declaredIn != null) {
            throw new InternalCompilerError(
                    "Can only set declaredIn once: was "
                            + this.declaredIn
                            + "&"
    ...
    public void setDeclaringClass(ClassType ct) {
        if (this.declaredIn == TVarDecl.CLASS_TYPE_VARIABLE && declaringClass == ct) {
            // nothing to do
            return;
        }
        if (this.declaredIn != null) {
    ...
    public ClassType declaringClass() {
        if (this.declaredIn == TVarDecl.CLASS_TYPE_VARIABLE) return this.declaringClass;
        return null;
    }

    @Override
    public JL5ProcedureInstance declaringProcedure() {
        if (this.declaredIn == TVarDecl.PROCEDURE_TYPE_VARIABLE) return this.declaringProcedure;
        return null;
    }
    ...
    public boolean equalsImpl(TypeObject t) {
        ...
        if (t instanceof TypeVariable_c) {
            ...
            return (this.name == other.name
                    ...
                    && (this.syntheticUniqueId == other.syntheticUniqueId
                            || (this.syntheticUniqueId != null
                                    && this.syntheticUniqueId.equals(other.syntheticUniqueId)))
                    // we don't use .equals on declaringClass and declaringProcedure to avoid
                    // infinite loops.
    ...
    public int hashCode() {
        return (this.name == null ? 0 : this.name.hashCode())
                ^ (this.syntheticUniqueId == null ? 0 : this.syntheticUniqueId.hashCode());
    }
    ...
    private void writeObject(ObjectOutputStream out) throws IOException {
        if (this.declaredIn == null || this.declaredIn == TVarDecl.SYNTHETIC_TYPE_VARIABLE) {
            throw new InternalCompilerError(
                    "Shouldn't serialize unknown or synthetic type variables", this.position());
        }
