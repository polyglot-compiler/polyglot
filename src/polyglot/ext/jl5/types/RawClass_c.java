...
public class RawClass_c extends JL5ClassType_c implements RawClass {
	...
	private JL5SubstClassType erased() {
		if (this.erased == null) {
			...
			this.erased = new JL5SubstClassType_c((JL5TypeSystem) ts,
					base.position(), (JL5ParsedClassType) base, es);
		}
		return this.erased;
	}
	...
	public List constructors() {
		if (constructors == null) {
			...
			for (ConstructorInstance ci : this.constructors) {
	...
	public List memberClasses() {
		if (memberClasses == null) {
			...
			// for (ClassType ct : this.memberClasses) {
	...
	public boolean descendsFromImpl(Type ancestor) {
		// System.err.println("   Raw class " + this + " descends from " +
		// ancestor + " ?  interfaces is " + this.interfaces() + "  ::: " +
		// super.descendsFromImpl(ancestor));
		// System.err.println("    base interfaces are " +
		// this.base.interfaces());
