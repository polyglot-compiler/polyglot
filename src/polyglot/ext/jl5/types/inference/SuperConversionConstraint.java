                    ...
                    if (!(formal_targ instanceof WildCardType)) {
                        if (!(actual_targ instanceof WildCardType)) {
                            ...
                            if (actual_targ_wc.isExtendsConstraint()) {
                                r.add(new SuperConversionConstraint(actual_targ_wc.upperBound(), formal_targ, solver));
                            }
                            else if (actual_targ_wc.isExtendsConstraint()) {
                                r.add(new SubConversionConstraint(actual_targ_wc.upperBound(), formal_targ, solver));
                            }
                        }
                    }
                        ...
                        if ((formal_targ_wc.isExtendsConstraint()) && (actual_targ_wc.isExtendsConstraint())) {
                            r.add(new SuperConversionConstraint(actual_targ_wc.upperBound(), formal_targ_wc.upperBound(), solver));
                        }
                        else if ((formal_targ_wc.isSuperConstraint())&& (actual_targ_wc.isSuperConstraint())) {
                            r.add(new SubConversionConstraint(actual_targ_wc.lowerBound(), formal_targ_wc.lowerBound(), solver));
                        }
                    }
                }
            }
