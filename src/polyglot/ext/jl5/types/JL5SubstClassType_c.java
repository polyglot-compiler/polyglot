...
public class JL5SubstClassType_c extends SubstClassType_c implements
		JL5SubstClassType {
	...
	public boolean descendsFromImpl(Type ancestor) {
		...
		// " <: " + ancestor);
		// System.err.println("    superclass of  " + this + " is " +
		// this.superType());
		// System.err.println("    base class of  " + this + " is " +
		// this.base());
		// System.err.println("       super of " + this.base() + " is " +
		// this.base().superType());
		// System.err.println("    subst  of  " + this + " is " + this.subst());
		// System.err.println("   applying subst " +
		// subst.substType(this.base()) + " super " +
		// ((ReferenceType)subst.substType(this.base())).superType());

		// See JLS 3rd ed 4.10.2
		if (hasWildCardArg()) {
			Type captured = ts.applyCaptureConversion(this);
			// Note: we want descendsFrom, not isSubtype, since the direct
		...
		if (ancestor instanceof JL5SubstClassType_c) {
			...
			if (this.base.equals(anc.base)) {
				...
				for (TypeVariable tv : base.typeVariables()) {
					...
					// System.err.println("      E " + ti +
					// " contained in "+si+" ? " + ts.isContained(ti, si));
