...
public class JL7NodeFactory_c extends JL5NodeFactory_c implements JL7NodeFactory {
    ...
    @Override
    public MultiCatch MultiCatch(
            Position pos, Formal formal, List<TypeNode> alternatives, Block body) {
    ...
    public LocalDecl Resource(
            ...
            Id name,
            Expr init) {
        LocalDecl n = super.LocalDecl(pos, flags, annotations, type, name, init);
    ...
    @Override
    public TryWithResources TryWithResources(
            Position pos,
            ...
            Block finallyBlock) {
        TryWithResources n =
                new TryWithResources_c(pos, resources, tryBlock, catchBlocks, finallyBlock);
