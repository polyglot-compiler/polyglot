 ...
 */
public abstract class ParamTypeSystem_c extends TypeSystem_c implements
		ParamTypeSystem {
	/**
	 ...
	 * 
	 * @param pos
	 *            The position of the instantiated type
	 * @param base
	 ...
	 *             when the actuals do not agree with the formals
	 */
	 ...
	 *             when the actuals do not agree with the formals
	 */
	protected void checkInstantiation(Position pos, PClass base, List actuals)
			throws SemanticException {
	...
	/**
	 * Instantiate a parametric type on a list of actual parameters, but do not
	 * check that the instantiation is legal.
	 * 
	 * @param pos
	 *            The position of the instantiated type
	 * @param base
	...
	protected ClassType uncheckedInstantiate(Position pos, PClass base,
		...
		if (i.hasNext() || j.hasNext()) {
			throw new InternalCompilerError("Wrong number of actual "
					+ "parameters for instantiation " + "of \"" + base + "\".",
					pos);
		}
	 ...
	 * 
	 * @param t
	 *            The type on which we perform substitutions.
	 * @param substMap
	 *            Map from formal parameters to actuals; the formals are not
	 *            necessarily formals of <code>t</code>.
	 */
	 ...
	 *            type to substituted type. This is passed in to ensure pointers
	 *            to outer classes are substituted correctly.
	 */
