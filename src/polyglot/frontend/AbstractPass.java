...
public abstract class AbstractPass implements Pass {
	...
	/**
	 * If the pass is running, the time that the pass started. If the pass has
	 * completed, the time in ms the pass took to run, excluding spawned passes.
	 */
	protected long exclusive_time = 0;

	/**
	 * If the pass is running, the time that the pass started. If the pass has
	 * completed, the time in ms the pass took to run, including spawned passes.
	 */
