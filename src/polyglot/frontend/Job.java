 ...
 * particular compilation unit carried between phases of the compiler. Only one
...
public class Job {
	...
	/**
	 * Return the <code>Source</code> associated with the <code>SourceJob</code>
	 * returned by <code>sourceJob</code>.
	 */
	...
	/**
	 * Returns whether the source for this job was explicitly specified by the
	 * user, or if it was drawn into the compilation process due to some
	 * dependency.
	 */
