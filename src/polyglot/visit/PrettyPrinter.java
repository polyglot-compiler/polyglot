...
/**
 * A PrettyPrinter generates output code from the processed AST. Output is sent
 * to a code writer passed into the printAst method.
 * 
 * To use: new PrettyPrinter().printAst(node, new CodeWriter(out));
 */
