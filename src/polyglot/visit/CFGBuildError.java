...
/**
 * Exception thrown when the CFG cannot be built. This should be a
 * SemanticException, but is an error so it doesn't need to be declared in the
 * signature of Node.acceptCFG.
 */
