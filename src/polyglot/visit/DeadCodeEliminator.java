...
public class DeadCodeEliminator extends DataFlow {
	public DeadCodeEliminator(Job job, TypeSystem ts, NodeFactory nf) {
		super(job, ts, nf, false /* backward analysis */, true /*
															 * perform dataflow
															 * on entry to
															 * CodeDecls
															 */);
	...
	/**
	 * Returns array of sets of local instances. Element 0 is the set of local
	 * instances DEFined by the node. Element 1 is the set of local instances
	 * USEd by the node.
	 */
