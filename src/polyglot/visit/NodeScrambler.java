...
/**
 * The <code>NodeScrambler</code> is test case generator of sorts. Since it is
 * ofter useful to introduce ``random'' errors into source code, this class
 * provides a way of doing so in a semi-structed manner. The process takes place
 * in two phases. First, a "FirstPass" is made to collect a list of nodes and
 * their parents. Then a second pass is made to randomly replace a branch of the
 * tree with another suitable branch.
 */
