...
public class ErrorHandlingVisitor extends HaltingVisitor {
	 ...
	 * sub-classes should over-ride this method instead of <code>enter()</code>
	 * if there is any chance of exceptions being generated.
	 * 
	 * This method is the replacement for the <code>enter()</code> method, so
	 * that all of its subclasses gain the error handling capabilities of this
	 * visitor without having to rewrite it for the <code>enter()</code> for
	 * each sub-class.
	 * 
	 * This method allows for a <code>SemanticException</code> to be thrown in
	 * the body, while <code>enter()</code> does not.
	 * 
	 * @see polyglot.visit.NodeVisitor#enter(Node, Node)
	 * @throws SemanticException
	 * @param n
	 *            The root of the subtree to be traversed.
	 * @return The <code>ErrorHandlingVisitor</code> which should be used to
	 *         visit the children of <code>n</code>.
	 */
	 ...
	 * @return The <code>ErrorHandlingVisitor</code> which should be used to
	 *         visit the childre of <code>n</code>.
	 */
	 ...
	 * </code> method, but allows <code>SemanticExceptions</code> to be thrown.
	 * 
	 * This method is in addition to the <code>leave</code> method, and allows
	 * the compiler writer to write code that can throw errors and let the
	 * polyglot infrastructure handle the exceptions.
	 * 
	 ...
	 * 
	 * In overriding this method, unless the class explicitly does not want to
	 * maintain any of the error handling aspects of this class, a call
	 * <code>super.enter</code> should be embedded within the method at the end.
	 * 
	 * @param n
	 *            The root of the subtree to be traversed.
	 ...
	 * In overriding this method, unless the class explicitly does not want to
	 * maintain any of the error handling aspects of this class, a call
	 * <code>super.leave</code> should be embedded within the method at the end.
	 * 
	 * @param old
	 *            The original state of root of the current subtree.
	 * @param n
