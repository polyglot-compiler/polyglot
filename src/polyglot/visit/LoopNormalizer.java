...
public class LoopNormalizer extends NodeVisitor {
	...
	protected Eval createAssign(LocalDecl var, Expr right) {
		...
		Eval a = nf
				.Eval(pos, (Assign) postCreate(nf.Assign(pos, left,
						Assign.ASSIGN, right)));
		a = (Eval) postCreate(a);
		return a;
	}
	 ...
	 * becomes
	 * 
	 * while (true) { boolean loop = e; if (loop) {...} else break; }
	 */
	 ...
	 * becomes
	 * 
	 * boolean loop = false; while (true) { if (loop) loop = e; else loop =
	 * true; if (loop) {...} else break; }
	 */
	 ...
	 * becomes
	 * 
	 * int i = 0; boolean loop = false; while (true) { if (loop) i++; loop = i <
	 * 10; if (loop) {...} else break; }
	 */
