...
public abstract class Version {
	/**
	 * The name of the language. Files produced by different languages are not
	 * compatible.
	 */
	 ...
	 * format. Source files will be prefered over class files build by compilers
	 * with different minor versions, but if no source file is available, then
	 * the class file will be used.
	 */
