...
public class ClassDecl_c extends Node_c implements ClassDecl
{
    ...
    public Node disambiguateOverride_(AmbiguityRemover ar)
        ...
        if (this.superClass != null) {
            superClass = (TypeNode) this.superClass.visit(ar);
        ...
        ClassBody body = (ClassBody) this.body.visit(ar);

        ClassDecl_c n = reconstruct(superClass, interfaces, body);
