...
/**
 * A <code>ArrayAccessAssign_c</code> represents a Java assignment expression to
 * an array element. For instance, <code>A[3] = e</code>.
 * 
...
public class ArrayAccessAssign_c extends Assign_c implements ArrayAccessAssign {
	...
	protected void acceptCFGOpAssign(CFGBuilder v) {
		 ...
		 * v.visitCFG(a.array(), a.index().entry()); v.visitCFG(a.index(), a);
		 * v.visitThrow(a); v.edge(a, right().entry()); v.visitCFG(right(),
		 * this);
		 */
