...
/**
 * This abstract implementation of <code>ExtFactory</code> provides a way of
 * chaining together ExtFactories, and default implementations of factory
 ...
 * The method <code>extN()</code> calls <code>extNImpl()</code> to create an
 * appropriate extension object, and if other <code>ExtFactory</code>s are
 * chained onto this one, it will also call <code>extN()</code> on the next
 * <code>ExtFactory</code>. The method <code>extN()</code> will then call
 * <code>postExtN</code>, passing in the newly created extension object.
 * 
 * <p>
 * The default implementation of <code>extNImpl()</code> is to simply call
 * <code>extMImpl()</code>, where <code>M</code> is the immediate superclass of
 * <code>N</code>. Similarly, the default implementation of
...
public abstract class AbstractExtFactory_c implements ExtFactory {
	...
	/**
	 * Compose two extensions together. Order is important: e1 gets added at the
	 * end of e2's chain of extensions.
	 * 
	 * @param e1
	 *            the <code>Ext</code> object to add to the end of e2's chain of
	 *            extensions.
	 * @param e2
	 *            the second <code>Ext</code> object that will have e1 added to
	 ...
	 * 
	 * @return the <code>Ext</code> object for a <code>AmbAssign</code> AST
	 *         node.
	 */
	 ...
	 * 
	 * @return the <code>Ext</code> object for a <code>AmbPrefix</code> AST
	 *         node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>AmbQualifierNode</code>
	 * AST node.
	 * 
	 * @return the <code>Ext</code> object for a <code>AmbQualifierNode</code>
	 *         AST node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>AmbReceiver</code> AST
	 * node.
	 * 
	 * @return the <code>Ext</code> object for a <code>AmbReceiver</code> AST
	 *         node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>AmbTypeNode</code> AST
	 * node.
	 * 
	 * @return the <code>Ext</code> object for a <code>AmbTypeNode</code> AST
	 *         node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>ArrayAccess</code> AST
	 * node.
	 * 
	 * @return the <code>Ext</code> object for a <code>ArrayAccess</code> AST
	 *         node.
	 */
	 ...
	 * 
	 * @return the <code>Ext</code> object for a <code>ArrayInit</code> AST
	 *         node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>ArrayTypeNode</code> AST
	 * node.
	 * 
	 * @return the <code>Ext</code> object for a <code>ArrayTypeNode</code> AST
	 *         node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>LocalAssign</code> AST
	 * node.
	 * 
	 * @return the <code>Ext</code> object for a <code>LocalAssign</code> AST
	 *         node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>FieldAssign</code> AST
	 * node.
	 * 
	 * @return the <code>Ext</code> object for a <code>FieldAssign</code> AST
	 *         node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>ArrayAccessAssign</code>
	 * AST node.
	 * 
	 * @return the <code>Ext</code> object for a <code>ArrayAccessAssign</code>
	 *         AST node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>BooleanLit</code> AST
	 * node.
	 * 
	 * @return the <code>Ext</code> object for a <code>BooleanLit</code> AST
	 *         node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>CanonicalTypeNode</code>
	 * AST node.
	 * 
	 * @return the <code>Ext</code> object for a <code>CanonicalTypeNode</code>
	 *         AST node.
	 */
	 ...
	 * 
	 * @return the <code>Ext</code> object for a <code>ClassBody</code> AST
	 *         node.
	 */
	 ...
	 * 
	 * @return the <code>Ext</code> object for a <code>ClassDecl</code> AST
	 *         node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>ClassMember</code> AST
	 * node.
	 * 
	 * @return the <code>Ext</code> object for a <code>ClassMember</code> AST
	 *         node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>CompoundStmt</code> AST
	 * node.
	 * 
	 * @return the <code>Ext</code> object for a <code>CompoundStmt</code> AST
	 *         node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>Conditional</code> AST
	 * node.
	 * 
	 * @return the <code>Ext</code> object for a <code>Conditional</code> AST
	 *         node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>ConstructorCall</code> AST
	 * node.
	 * 
	 * @return the <code>Ext</code> object for a <code>ConstructorCall</code>
	 *         AST node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>ConstructorDecl</code> AST
	 * node.
	 * 
	 * @return the <code>Ext</code> object for a <code>ConstructorDecl</code>
	 *         AST node.
	 */
	 ...
	 * 
	 * @return the <code>Ext</code> object for a <code>FieldDecl</code> AST
	 *         node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>Initializer</code> AST
	 * node.
	 * 
	 * @return the <code>Ext</code> object for a <code>Initializer</code> AST
	 *         node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>Instanceof</code> AST
	 * node.
	 * 
	 * @return the <code>Ext</code> object for a <code>Instanceof</code> AST
	 *         node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>LocalClassDecl</code> AST
	 * node.
	 * 
	 * @return the <code>Ext</code> object for a <code>LocalClassDecl</code> AST
	 *         node.
	 */
	 ...
	 * 
	 * @return the <code>Ext</code> object for a <code>LocalDecl</code> AST
	 *         node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>MethodDecl</code> AST
	 * node.
	 * 
	 * @return the <code>Ext</code> object for a <code>MethodDecl</code> AST
	 *         node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>PackageNode</code> AST
	 * node.
	 * 
	 * @return the <code>Ext</code> object for a <code>PackageNode</code> AST
	 *         node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>ProcedureDecl</code> AST
	 * node.
	 * 
	 * @return the <code>Ext</code> object for a <code>ProcedureDecl</code> AST
	 *         node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>SourceCollection</code>
	 * AST node.
	 * 
	 * @return the <code>Ext</code> object for a <code>SourceCollection</code>
	 *         AST node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>SourceFile</code> AST
	 * node.
	 * 
	 * @return the <code>Ext</code> object for a <code>SourceFile</code> AST
	 *         node.
	 */
	 ...
	 * 
	 * @return the <code>Ext</code> object for a <code>StringLit</code> AST
	 *         node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>SwitchBlock</code> AST
	 * node.
	 * 
	 * @return the <code>Ext</code> object for a <code>SwitchBlock</code> AST
	 *         node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>SwitchElement</code> AST
	 * node.
	 * 
	 * @return the <code>Ext</code> object for a <code>SwitchElement</code> AST
	 *         node.
	 */
	...
	/**
	 * Create the <code>Ext</code> object for a <code>Synchronized</code> AST
	 * node.
	 * 
	 * @return the <code>Ext</code> object for a <code>Synchronized</code> AST
	 *         node.
	 */
