...
/**
 * A <code>Binary</code> represents a Java binary expression, an immutable pair
 * of expressions combined with an operator.
 */
public interface Binary extends Expr {
	...
	/**
	 * Returns true if the binary might throw an arithmetic exception, such as
	 * division by zero.
	 */
