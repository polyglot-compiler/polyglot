...
/**
 * A <code>SourceFile</code> is an immutable representations of a Java language
...
public interface SourceFile extends Node {
	 ...
	 * 
	 * @param imports
	 *            A list of {@link polyglot.ast.Import Import}.
	 */
	 ...
	 * 
	 * @param decls
	 *            A list of {@link polyglot.ast.TopLevelDecl TopLevelDecl}.
	 */
