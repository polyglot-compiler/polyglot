...
/**
 * A <code>SourceCollection</code> represents a collection of source files. This
 * node should be used only during AST rewriting, just before code generation in
 * order to generate multiple target files from a single AST.
 */
