...
public interface ConstructorDecl extends ProcedureDecl {
	...
	/**
	 * The constructor's name. This should be the short name of the containing
	 * class.
	 */
	Id id();
	 ...
	 * 
	 * @param formals
	 *            A list of {@link polyglot.ast.Formal Formal}.
	 */
	 ...
	 * 
	 * @param throwTypes
	 *            A list of {@link polyglot.ast.TypeNode TypeNode}.
	 */
	ConstructorDecl throwTypes(List throwTypes);

	/**
	 * The constructor type object. This field may not be valid until after
