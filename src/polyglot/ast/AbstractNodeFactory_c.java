...
/**
 * This is a node factory that creates no nodes. It, rather than NodeFactory_c,
 * should be subclassed by any extension which should override the creation of
 * <a>all</a> nodes.
 */
public abstract class AbstractNodeFactory_c implements NodeFactory {
	...
	public TypeNode TypeNodeFromQualifiedName(Position pos, String qualifiedName) {
		...
		return AmbTypeNode(pos,
				QualifierNodeFromQualifiedName(pos2, container), name);
	}
	...
	public final ClassDecl ClassDecl(Position pos, Flags flags, String name,
		...
		return ClassDecl(pos, flags, Id(pos, name), superClass, interfaces,
				body);
	}

	public final ConstructorDecl ConstructorDecl(Position pos, Flags flags,
			String name, List formals, List throwTypes, Block body) {
		return ConstructorDecl(pos, flags, Id(pos, name), formals, throwTypes,
				body);
	}
	...
	public final ConstructorCall ConstructorCall(Position pos,
			ConstructorCall.Kind kind, List args) {
	...
	public final MethodDecl MethodDecl(Position pos, Flags flags,
			TypeNode returnType, String name, List formals, List throwTypes,
			Block body) {
		return MethodDecl(pos, flags, returnType, Id(pos, name), formals,
				throwTypes, body);
	}
