...
public abstract class Assign_c extends Expr_c implements Assign {
	...
	public Node typeCheck(TypeChecker tc) throws SemanticException {
		...
		if (!(left instanceof Variable)) {
			throw new SemanticException(
					"Target of assignment must be a variable.", position());
		}
	...
	/**
	 * Construct a CFG for this assignment when the assignment operator is
	 * ASSIGN (i.e., the normal, simple assignment =).
	 */
	protected abstract void acceptCFGAssign(CFGBuilder v);

	/**
	 * Construct a CFG for this assignment when the assignment operator is of
	 * the form op= for some operation op.
	 */
