 ...
 */
@Deprecated
public class JLDelNodeFactory_c extends NodeFactory_c {
    ...
    public JLDelNodeFactory_c() {
        this(new EmptyExtFactory(), new EmptyDelFactory());
    }

    public JLDelNodeFactory_c(ExtFactory extFactory) {
        this(extFactory, new EmptyDelFactory());
    }

    public JLDelNodeFactory_c(ExtFactory extFactory, DelFactory delFactory) {
        super(extFactory);
