...
public interface FieldDecl extends ClassMember, VarInit, CodeNode {
	...
	/**
	 * Get the type object for the field we are declaring. This field may not be
	 * valid until after signature disambiguation.
	 */
	...
	/**
	 * Get the type object for the initializer expression, or null. We evaluate
	 * the initializer expression as if it were in an initializer block (e.g.,
	 * <code>{ }</code> or </code>static { }<code>).
	 */
