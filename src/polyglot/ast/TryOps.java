...
public interface TryOps {
     ...
     * @throws SemanticException
     */
    List<Catch> exceptionCheckCatchBlocks(ExceptionChecker ec) throws SemanticException;
     ...
     * @throws SemanticException
     */
    Block exceptionCheckFinallyBlock(ExceptionChecker ec) throws SemanticException;
}
