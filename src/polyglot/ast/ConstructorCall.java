...
/**
 * A <code>ConstructorCall</code> represents a direct call to a constructor. For
 * instance, <code>super(...)</code> or <code>this(...)</code>.
 */
public interface ConstructorCall extends Stmt, ProcedureCall {
	...
	/**
	 * The constructor that is called. This field may not be valid until after
	 * type checking.
	 */
