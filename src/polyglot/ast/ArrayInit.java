...
/**
 * An <code>ArrayInit</code> is an immutable representation of an array
 * initializer, such as { 3, 1, { 4, 1, 5 } }. Note that the elements of these
 * array may be expressions of any type (e.g., <code>Call</code>).
 */
public interface ArrayInit extends Expr {
	 ...
	 * left-hand-side type. Each element is checked to see if it can be assigned
	 * to a variable of type lhsType.
	 * 
	 * @param lhsType
