 ...
 * item being imported and the kind which is either indicating that a class is
 * being imported, or that an entire package is being imported.
 */
public interface Import extends Node {
	/**
	 * Import kinds: class (e.g., import java.util.Set) or package (e.g., import
	 * java.util.*).
	 * 
	 * PACKAGE is a bit of a misnomer, since we can import p.C.*, where p.C is a
	 * class. This puts the nested classes of p.C in scope.
	 */
