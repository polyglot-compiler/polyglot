...
/**
 * An <code>IntLit</code> represents a literal in Java of an integer type.
 */
public class IntLit_c extends NumLit_c implements IntLit {
	...
	/**
	 * @return True if this is a boundary case: the literal can only appear as
	 *         the operand of a unary minus.
	 */
