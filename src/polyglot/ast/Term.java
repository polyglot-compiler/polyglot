...
public interface Term extends Node {
	...
	/**
	 * Visit this node, calling calling v.edge() for each successor in succs, if
	 * data flows on that edge.
	 */
	public List acceptCFG(CFGBuilder v, List succs);

	/**
	 * Returns true if the term is reachable. This attribute is not guaranteed
	 * correct until after the reachability pass.
	 * 
	...
	/**
	 * List of Types with all exceptions possibly thrown by this term. The list
	 * is not necessarily correct until after exception-checking.
