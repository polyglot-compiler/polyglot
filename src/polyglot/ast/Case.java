...
public interface Case extends SwitchElement {
	/**
	 * Get the case label. This must should a constant expression. The case
	 * label is null for the <code>default</code> case.
	 */
	Expr expr();
	...
	/**
	 * Returns the value of the case label. This value is only valid after
	 * type-checking.
	 */
	long value();
