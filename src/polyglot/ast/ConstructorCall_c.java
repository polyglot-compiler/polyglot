...
public class ConstructorCall_c extends Stmt_c implements ConstructorCall {
	...
	/**
	 * An explicit constructor call is a static context. We need to record this.
	 */
	...
	public Node buildTypes(TypeBuilder tb) throws SemanticException {
		...
		// XXX Avoid using ts.Object(), which might throw
		// MissingDependencyException,
		// and cause everything before the constructor declaration to be added
		// twice.
		if (kind == SUPER
	...
	public Node copy(NodeFactory nf) {
		return nf.ConstructorCall(this.position, this.kind, this.qualifier,
				this.arguments);
	}
