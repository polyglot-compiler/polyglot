...
/**
 * A <code>Conditional</code> is a representation of a Java ternary expression.
 * That is, <code>(cond ? consequent : alternative)</code>.
 */
public class Conditional_c extends Expr_c implements Conditional {
	...
	public Node typeCheck(TypeChecker tc) throws SemanticException {
		...
		throw new SemanticException(
				"Could not determine type of ternary conditional expression; cannot assign "
						+ t1 + " to " + t2 + " or vice versa.", position());
	}
	...
	public Node copy(NodeFactory nf) {
		return nf.Conditional(this.position, this.cond, this.consequent,
				this.alternative);
	}
