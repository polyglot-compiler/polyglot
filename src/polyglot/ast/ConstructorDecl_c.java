...
public class ConstructorDecl_c extends Term_c implements ConstructorDecl {
	...
	public ConstructorDecl_c(Position pos, Flags flags, Id name, List formals,
			List throwTypes, Block body) {
		super(pos);
		assert (flags != null && name != null && formals != null && throwTypes != null); // body
																							// may
																							// be
																							// null
		this.flags = flags;
		...
		this.throwTypes = TypedList.copyAndCheck(throwTypes, TypeNode.class,
				true);
		this.body = body;
	}
	...
	protected ConstructorDecl_c reconstruct(Id name, List formals,
			List throwTypes, Block body) {
	...
	public Node copy(NodeFactory nf) {
		return nf.ConstructorDecl(this.position, this.flags, this.name,
				this.formals, this.throwTypes, this.body);
	}
