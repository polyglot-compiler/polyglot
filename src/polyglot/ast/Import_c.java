...
public class Import_c extends Node_c implements Import {
	...
	/**
	 * Build type objects for the import. public Node buildTypes(TypeBuilder tb)
	 * throws SemanticException { ImportTable it = tb.importTable();
	 * 
	 * if (kind == CLASS) { it.addClassImport(name); } else if (kind == PACKAGE)
