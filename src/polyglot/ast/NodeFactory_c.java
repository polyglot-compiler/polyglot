 ...
 * go through this factory or by done with the <code>copy()</code> method of
 * <code>Node</code>.
 */
public class NodeFactory_c extends AbstractNodeFactory_c {
	...
	public SwitchBlock SwitchBlock(Position pos, List statements) {
		SwitchBlock n = new SwitchBlock_c(pos,
	...
	public ConstructorCall ConstructorCall(Position pos,
			ConstructorCall.Kind kind, Expr outer, List args) {
		ConstructorCall n = new ConstructorCall_c(pos, kind, outer,
	...
	public ConstructorDecl ConstructorDecl(Position pos, Flags flags, Id name,
		...
		ConstructorDecl n = new ConstructorDecl_c(pos, flags, name,
				CollectionUtil.nonNullList(formals),
				CollectionUtil.nonNullList(throwTypes), body);
	...
	public For For(Position pos, List inits, Expr cond, List iters, Stmt body) {
		For n = new For_c(pos, CollectionUtil.nonNullList(inits), cond,
				CollectionUtil.nonNullList(iters), body);
	...
	public MethodDecl MethodDecl(Position pos, Flags flags,
			...
			Block body) {
		MethodDecl n = new MethodDecl_c(pos, flags, returnType, name,
				CollectionUtil.nonNullList(formals),
				CollectionUtil.nonNullList(throwTypes), body);
	...
	public New New(Position pos, Expr outer, TypeNode objectType, List args,
			ClassBody body) {
		New n = new New_c(pos, outer, objectType,
				CollectionUtil.nonNullList(args), body);
	...
	public NewArray NewArray(Position pos, TypeNode base, List dims,
		...
		NewArray n = new NewArray_c(pos, base,
	...
	public SourceCollection SourceCollection(Position pos, List sources) {
		SourceCollection n = new SourceCollection_c(pos,
	...
	public SourceFile SourceFile(Position pos, PackageNode packageName,
		...
		SourceFile n = new SourceFile_c(pos, packageName,
	...
	public Try Try(Position pos, Block tryBlock, List catchBlocks,
			Block finallyBlock) {
		Try n = new Try_c(pos, tryBlock,
				CollectionUtil.nonNullList(catchBlocks), finallyBlock);
