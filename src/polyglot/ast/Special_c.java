...
/**
 * A <code>Special</code> is an immutable representation of a reference to
 * <code>this</code> or <code>super</code in Java. This reference can be
 * optionally qualified with a type such as <code>Foo.this</code>.
 */
			...
			if (qualifier.type().isClass()) {
				...
				if (!c.currentClass().hasEnclosingInstance(t)) {
					throw new SemanticException("The nested class \""
							...
							+ "an enclosing instance of type \"" + t + "\".",
							qualifier.position());
				}
			} else {
				throw new SemanticException(
						"Invalid qualifier for \"this\" or \"super\".",
						qualifier.position());
			}
		}
