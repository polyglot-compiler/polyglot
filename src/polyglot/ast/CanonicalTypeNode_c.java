...
public class CanonicalTypeNode_c extends TypeNode_c implements
	...
	/**
	 * Translate the type. If the "use-fully-qualified-class-names" options is
	 * used, then the fully qualified names is written out (
	 * <code>java.lang.Object</code>). Otherwise, the string that originally
	 * represented the type in the source file is used.
	 */
	...
	public Node copy(NodeFactory nf) {
		CanonicalTypeNode result = nf.CanonicalTypeNode(this.position,
				this.type);
		return result;
	}
