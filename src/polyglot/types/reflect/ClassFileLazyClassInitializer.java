...
public class ClassFileLazyClassInitializer implements LazyClassInitializer {
	...
	protected MethodInstance methodInstance(Method method, ClassType ct) {
		...
		return ts.methodInstance(ct.position(), ct,
				ts.flagsForBits(method.getModifiers()), returnType, name,
				argTypes, excTypes);
	}
	 ...
	 * 
	 * @param method
	 *            The JVM Method data structure for the constructor.
	 * @param ct
	 *            The class containing the method.
	 * @param fields
	 *            The constructor's fields, needed to remove parameters passed
	 *            to initialize synthetic fields.
	 */
	protected ConstructorInstance constructorInstance(Method method,
		...
		return ts.constructorInstance(mi.position(), ct, mi.flags(), formals,
				mi.throwTypes());
	}
	 ...
	 * 
	 * @param field
	 *            The JVM Field data structure for the field.
	 * @param ct
