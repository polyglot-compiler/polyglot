...
public class ClassFile_c implements ClassFile {
    ...
    protected JavaFileObject classFileSource;
     ...
     * @throws IOException 
     */
    public ClassFile_c(JavaFileObject classFileSource, byte[] code, ExtensionInfo ext) throws IOException {
    ...
    /* (non-Javadoc)
	 * @see polyglot.types.reflect.ClassFileI#sourceLastModified(java.lang.String)
	 */
 ...
 */
  ...
  /* (non-Javadoc)
 * @see polyglot.types.reflect.ClassFileI#readAttributes(java.io.DataInputStream)
 */
       ...
       throws IOException
  {
    ...
    /* (non-Javadoc)
	 * @see polyglot.types.reflect.ClassFileI#createMethod(java.io.DataInputStream)
	 */
    ...
    /* (non-Javadoc)
	 * @see polyglot.types.reflect.ClassFileI#createField(java.io.DataInputStream)
	 */
    ...
    /* (non-Javadoc)
	 * @see polyglot.types.reflect.ClassFileI#createAttribute(java.io.DataInputStream, java.lang.String, int, int)
	 */
