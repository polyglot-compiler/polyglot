...
public interface ParsedClassType extends ClassType, ParsedTypeObject {
	...
	/**
	 * The <code>Source</code> that this class type was loaded from. Should be
	 * <code>null</code> if it was not loaded from a <code>Source</code> during
	 * this compilation.
	 */
	Source fromSource();
	...
	/**
	 * Set the name of the class. Throws <code>InternalCompilerError</code> if
