...
public class Flags implements Serializable {
	...
	protected static class FlagComparator implements Comparator {
		protected static List order = new ArrayList(Arrays.asList(new String[] {
				"public", "private", "protected", "static", "final",
				"synchronized", "transient", "native", "interface", "abstract",
				"volatile", "strictfp" }));
	...
	/** All access flags. */
	protected static final Flags ACCESS_FLAGS = PUBLIC.set(PRIVATE).set(
			PROTECTED);
	...
	/**
	 * Return a copy of this <code>this</code> with the <code>public</code> flag
	 * set.
	 */
	public Flags Public() {
		return set(PUBLIC);
	...
	/**
	 * Return a copy of this <code>this</code> with the <code>static</code> flag
	 * set.
	 */
	public Flags Static() {
		return set(STATIC);
	...
	/**
	 * Return a copy of this <code>this</code> with the <code>final</code> flag
	 * set.
	 */
	public Flags Final() {
		return set(FINAL);
	...
	/**
	 * Return a copy of this <code>this</code> with the <code>native</code> flag
	 * set.
	 */
	public Flags Native() {
		return set(NATIVE);
