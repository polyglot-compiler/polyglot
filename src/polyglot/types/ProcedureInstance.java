...
public interface ProcedureInstance extends CodeInstance {
	...
	/**
	 * Returns a String representing the signature of the procedure. This
	 * includes just the name of the method (or name of the class, if it is a
	 * constructor), and the argument types.
	 */
	String signature();

	/**
	 * String describing the kind of procedure, (e.g., "method" or
	 * "constructor").
	 */
	String designator();

	/**
	 * Return true if <code>this</code> is more specific than <code>pi</code> in
	 * terms of method overloading.
	 */
	...
	/**
	 * Returns true if the procedure throws a subset of the exceptions thrown by
	 * <code>pi</code>.
	 */
