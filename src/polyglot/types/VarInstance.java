...
public interface VarInstance extends TypeObject, Declaration {
	 ...
	 * 
	 * @param value
	 *            the constant value. Should be an instance of String, Boolean,
	 *            Byte, Short, Character, Integer, Long, Float, Double, or null.
	 */
	...
	/**
	 * Destructively set the type of the variable. This method should be
	 * deprecated.
	 */
