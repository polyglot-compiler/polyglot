 ...
 * constructor.
 */
public interface ConstructorInstance extends ProcedureInstance, Declaration {
    ...
    /**
     * Return true if this constructor has the same signature as {@code ci}.
     */
    boolean isSameConstructor(ConstructorInstance ci);
     ...
     * and by subclasses.
     */
    boolean isSameConstructorImpl(ConstructorInstance ci);
}
