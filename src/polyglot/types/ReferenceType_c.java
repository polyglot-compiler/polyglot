...
/**
 * A <code>ReferenceType</code> represents a reference type -- a type on which
...
public abstract class ReferenceType_c extends Type_c implements ReferenceType {
	...
	/**
	 * Returns a list of FieldInstances for all the fields declared in this. It
	 * does not return fields declared in supertypes.
	 */
