...
public interface MethodInstance extends FunctionInstance, MemberInstance,
	 ...
	 *         <code>this</code>. Note that this list does not include methods
	 *         declared in interfaces. Use <code>implemented</code> for that.
	...
	/**
	 * Return true if this method can override <code>mi</code>, throws a
	 * SemanticException otherwise.
	 */
	void checkOverride(MethodInstance mi) throws SemanticException;

	/**
	 * Get the set of methods this method implements. No ordering is specified
	 * since the superinterfaces need not form a linear list (i.e., they can
	 * form a tree).
	 * 
	...
	/**
	 * Return true if this method can be called with name <code>name</code> and
	 * actual parameters of types <code>actualTypes</code>.
	 * 
	 * @param name
	 *            The method to call.
	 * @param actualTypes
	 *            A list of argument types of type <code>Type</code>.
	 ...
	 * Get the list of methods this method (potentially) overrides, in order
	 * from this class (i.e., including <code>this</code>) to super classes.
	 * This method should not be called except by <code>TypeSystem</code> and by
	 * subclasses.
	 * 
	 * @return A list of <code>MethodInstance</code>, starting with
	 *         <code>this</code>.
	...
	/**
	 * Return true if this method can override <code>mi</code>. This method
	 * should not be called except by <code>TypeSystem</code> and by subclasses.
	...
	/**
	 * Get the set of methods in rt and its superinterfaces that this method
	 * implements. No ordering is specified.
	 * 
	 * @return List[MethodInstance]
	 * @param rt
	...
	/**
	 * Return true if this method can be called with name <code>name</code> and
	 * actual parameters of types <code>actualTypes</code>. This method should
	 * not be called except by <code>TypeSystem</code> and by subclasses.
	 */
