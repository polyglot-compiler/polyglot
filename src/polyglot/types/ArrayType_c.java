...
public class ArrayType_c extends ReferenceType_c implements ArrayType {
	...
	protected Object createLengthFieldInstance() {
		FieldInstance fi = ts.fieldInstance(position(), this, ts.Public()
				.Final(), ts.Int(), "length");
		fi.setNotConstant();
		return fi;
	}
	...
	protected MethodInstance createCloneMethodInstance() {
		return ts.methodInstance(position(), this, ts.Public(), ts.Object(),
				"clone", Collections.EMPTY_LIST, Collections.EMPTY_LIST);
	}
