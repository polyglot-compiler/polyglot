...
class TypeDumper {
	...
	static {
		Object[] primitiveLike = { Void.class, Boolean.class, Short.class,
				Integer.class, Long.class, Float.class, Double.class,
				Class.class, String.class, };
		dontExpand = new java.util.HashSet(
				java.util.Arrays.asList(primitiveLike));
	}
	...
	public static TypeDumper load(String name, TypeSystem ts)
		...
		try {
			...
			return new TypeDumper(name, te.decode(t, name),
