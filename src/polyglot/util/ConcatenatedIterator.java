 ...
 * 
 * Overview: This iterator wraps other iterators, and returns all their elements
 * in order.
 * 
...
public final class ConcatenatedIterator implements Iterator {
	/**
	 * Constructs a new ConcatenatedIterator which yields all of the elements of
	 * <iter1>, followed by all the elements of <iter2>.
	 **/
