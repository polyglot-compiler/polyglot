...
/**
 * This unmodifiable List supports performing an arbitrary transformation on the
 * underlying list's elements. The transformation is applied on every access to
