 ...
 * FilteringIterator
 * 
 * Overview: This iterator wraps another iterator, and returns only those
 * elements for which a given predicate is true.
 * 
...
public final class FilteringIterator implements Iterator {
	...
	/**
	 * Constructs a new FilteringIterator which returns all the elements of
	 * <iter>, in order, only when they have <pred> true.
	 **/
