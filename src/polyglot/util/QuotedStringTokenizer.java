...
public class QuotedStringTokenizer extends StringTokenizer {
	...
	/**
	 * Constructs a string tokenizer for the specified string. The default
	 * delimiters for StringTokenizer are used. "\"\'" are used as quotes, and
	...
	/**
	 * Constructs a string tokenizer for the specified string. "\"\'" are used
	 * as quotes, and '\\' is used as the escape character.
	 */
	...
	/**
	 * Constructs a string tokenizer for the specified string. Quotes cannot be
	 * delimiters, and the escape character can be neither a quote nor a
	 * delimiter.
	 */
	...
	/**
	 * Returns the position of the next non-delimiter character. Pre-condition:
	 * not inside a quoted string (token).
	 */
	...
	/**
	 * Returns the position of the next delimiter character after the token. If
	 * collect is true, collects the token into the StringBuffer. Pre-condition:
	 * not on a delimiter.
	 */
