 ...
 * to multiple values. It is therefore an arbitrary binary relation on keys and
 * values.
 */
public class MultiMap extends AbstractMap {
	...
	/**
	 * Makes <code>key</code> map to <code>value</code>, where
	 * <code>value</code> has to be a collection of objects.
	 */
