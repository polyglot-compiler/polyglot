...
/**
 * This exception is thrown when a PlaceHolder cannot be resolved during
 * deserialization. The thrower should set up a goal to resolve the place holder
 * in another pass. When caught, deserialization should fail.
 */
