...
public class StringUtil {
	...
	/**
	 * Given the name for a class, returns the portion which appears to
	 * constitute the package -- i.e., all characters after the last dot, or all
	 * the characters if the name has no dot.
	 **/
	...
	/**
	 * Returns true iff the provided class name does not appear to be qualified
	 * (i.e., it has no dot.)
	 **/
	...
	/**
	 * Returns the string that c escapes to, null if c does not require
	 * escaping.
	 */
