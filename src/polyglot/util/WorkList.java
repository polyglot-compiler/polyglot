...
/**
 * This class represents a set of calculations to be performed, some of which
 * have already been completed. It optionally stores the results of those
 * calculations.
 * 
 * Requires: every 'calculation' object has a working hashcode and toString
 * method.
 **/
public class WorkList {
	...
	/**
	 * Adds every member of the collection <c> to the worklist, if it has not
	 * already been calculted.
	 **/
	 ...
	 * getting the result <result>. Removes <work> from the pending list, and
	...
	/**
	 * Returns an immutable view of a map from calculation objects to their
	 * results. Non-computed values map to NOT_CALCULATED
	 **/
	public Map getMap() {
