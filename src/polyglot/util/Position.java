 ...
 * where each AST node is located in a source file; this is used, for example,
...
public class Position implements Serializable {
	...
	public static final Position COMPILER_GENERATED = new Position(null,
			"Compiler Generated");
	...
	public static Position compilerGenerated(int depth) {
		...
		if (depth < stack.length) {
			return new Position(null, stack[depth].getFileName()
					+ " (compiler generated)", stack[depth].getLineNumber());
		} else {
			return COMPILER_GENERATED;
		}
	}
	...
	public Position(Position start, Position end) {
		this(start.path(), start.file(), start.line, start.column, end.endLine,
				end.endColumn, start.offset, end.endOffset);
	}
	...
	public Position startOf() {
		if (this == COMPILER_GENERATED)
			return this;
		return new Position(path, file, line, column, line, column, offset,
				offset);
	}
