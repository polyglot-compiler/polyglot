 ...
 * and some additional <code>Object</code> arguments. Each pattern in the format
 * string is matched with its corresponding <code>Object</code>.
 * 
 * <p>
 ...
 * 
 * <li> <code>%LT</code> matches <code>List&lt;Type&gt;</code> or
 * <code>List&lt;TypeNode&gt;</code>
...
public class QQ {
	...
	/**
	 * Create a new quasiquoter to create AST nodes of the given language
	 * extension.
	 */
	...
	/**
	 * Create a new quasiquoter to create AST nodes of the given language
	 * extension, using <code>pos</code> for the position of the nodes created.
	 */
	...
	/**
	 * Parse a string into a <code>SourceFile</code> AST node, applying
	 * substitutions.
	 */
	...
	public SourceFile parseFile(String fmt, Object o1, Object o2, Object o3,
		...
		return (SourceFile) parse(fmt, list(o1, o2, o3, o4, o5, o6, o7, o8),
				FILE);
	}
	...
	public SourceFile parseFile(String fmt, Object o1, Object o2, Object o3,
		...
		return (SourceFile) parse(fmt,
				list(o1, o2, o3, o4, o5, o6, o7, o8, o9), FILE);
	}
	...
	/**
	 * Parse a string into a <code>ClassDecl</code> AST node, applying
	 * substitutions.
	 */
	...
	{
		return (ClassDecl) parse(fmt, list(o1, o2, o3, o4, o5, o6, o7, o8),
				DECL);
	}
	...
	{
		return (ClassDecl) parse(fmt, list(o1, o2, o3, o4, o5, o6, o7, o8, o9),
				DECL);
	}
	...
	/**
	 * Parse a string into a <code>ClassMember</code> AST node, applying
	 * substitutions.
	 */
	...
	{
		return (ClassMember) parse(fmt, list(o1, o2, o3, o4, o5, o6, o7, o8),
				MEMB);
	}
	...
	{
		return (ClassMember) parse(fmt,
				list(o1, o2, o3, o4, o5, o6, o7, o8, o9), MEMB);
	}
	...
	/**
	 * Parse a string into a <code>Expr</code> AST node, applying substitutions.
	 */
	...
	/**
	 * Parse a string into a <code>Stmt</code> AST node, applying substitutions.
	 */
	...
	/**
	 * Parse a string into a <code>TypeNode</code> AST node, applying
	 * substitutions.
	 */
	...
	{
		return (TypeNode) parse(fmt, list(o1, o2, o3, o4, o5, o6, o7, o8, o9),
				TYPE);
	}
	...
	/**
	 * Parse a string into an AST node of the given type, applying
	 * substitutions.
	 */
