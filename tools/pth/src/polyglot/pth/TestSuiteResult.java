...
public final class TestSuiteResult extends TestResult {
	...
	/**
	 * The name of the results file is the name of script file, bracketed with
	 * RESULTS_FILE_PREFIX and RESULT_FILE_SUFFIX.
	 */
	...
	public TestSuiteResult(Test t, Date dateTestRun, Map testResults,
			Date dateLastSuccess) {
