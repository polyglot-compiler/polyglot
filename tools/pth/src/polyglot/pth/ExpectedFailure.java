...
public class ExpectedFailure {
	...
	public boolean equals(Object o) {
		if (o instanceof ExpectedFailure) {
			...
			return (that.kind == this.kind || (that.kind != null && that.kind
					.equals(this.kind)))
					&& (that.errMsgRegExp == this.errMsgRegExp || (that.errMsgRegExp != null && that.errMsgRegExp
							.equals(this.errMsgRegExp)));
		}
		return false;
	}
