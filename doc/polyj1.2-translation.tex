...
extends the existing translation visitor in JLTools.  The PolyJ
...
package \verb-jltools.ext.polyj.util-.
...
\paragraph{Files:}
\begin{itemize}
\item \verb-jltools.ext.polyj.ast.PolyJClassNode-
\end{itemize}
...
\paragraph{Files:}
\begin{itemize}
\item \verb-jltools.ext.polyj.visit.PolyJTranslationVisitor-
\end{itemize}
...
\paragraph{Files:}
\begin{itemize}
\item \verb+jltools.ext.polyj.ast.PolyJCastExpression+
\item \verb+jltools.ext.polyj.ast.PolyJInstanceOfExpression+
\end{itemize}
...
\paragraph{Files:}
\begin{itemize}
\item \verb+jltools.ext.polyj.ast.PolyJMethodExpression+
\end{itemize}
...
\paragraph{Files:}
\begin{itemize}
\item \verb+jltools.ext.polyj.ast.PolyJConstructorCallStatement+
\end{itemize}
...
\paragraph{Files:}
\begin{itemize}
\item \verb+jltools.ext.polyj.ast.PolyJFieldExpression+
\end{itemize}
